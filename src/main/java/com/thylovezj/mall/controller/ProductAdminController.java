...
import com.thylovezj.mall.model.request.UpdateProductReq;
    ...
    public ApiRestResponse upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) {
        ...
        if (!fileDirectory.exists()) {
            if (!fileDirectory.mkdir()) {
                throw new ThylovezjMallException(ThylovezjMallExceptionEnum.MKDIR_FAILED);
            }
        }
        try {
        ...
        try {
            ...
            return ApiRestResponse.error(ThylovezjMallExceptionEnum.UPLOAD_FAILED);
        }
    }
